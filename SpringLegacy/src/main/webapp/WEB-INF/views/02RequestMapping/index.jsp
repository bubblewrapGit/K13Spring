...
<div class="container">
	...
	<form action="<%=ctxPath%>/requestMapping/postLogin.do" method="post" name="loginFrm" onsubmit="return loginCheck(this);">
	...
	<h3>@ModelAttribute 어노테이션 사용하여 커맨트객체 이름 변경하기</h3>
	<script type="text/javascript">
