...
public class ListCommand implements BbsCommandImpl{
	...
	public ListCommand() {
		System.out.println("ListCommand 빈 자동 생성됨");
	}
	...
	public void execute(Model model) {
		...
		/****** 페이징 처리 코드 add ********/
		String pagingImg = PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, nowPage, req.getContextPath()+"/bootSkin/listT.do?"+addQueryString);
